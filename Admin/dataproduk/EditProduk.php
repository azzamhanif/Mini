    ...
    <div id="content-wrapper" class="d-flex flex-column">
      ...
      <div id="content">
        ...
        <div class="container-fluid">
          ...
          <p class="mb-4">Mengubah data produk</p>
                ...
                <div class="container">
                  <div class="content">
                    ...
                    if(isset($_POST['save'])){ // jika tombol 'Save' dengan properti name="save" pada baris 135 ditekan
                      ...
                      $update = mysqli_query($koneksi, "UPDATE produk SET nama='$nama', deskripsi='$deskripsi', idkategori='$idkategori', idsub_kategori='$idsub_kategori', file_gambar='$namaFile', idpegawai='$idpegawai', harga='$harga' WHERE id='$id'") or die(mysqli_error()); // query untuk mengupdate nilai entri dalam database
                      if($update){ // jika query update berhasil dieksekusi
                        echo '<div class="alert alert-success alert-dismissable"><button type="button" class="close" data-dismiss="alert" aria-hidden="true">&times;</button> Data berhasil diedit.</div>'; // tambahkan pesan=sukses pada url
                    ...
                    <form class="form-horizontal" method="post" enctype="multipart/form-data">
                      ...
                      <div class="form-group">
                        ...
                        <div class="col-sm-2">
                          <select name="idsub_kategori" class="form-control">
                            <option>---Pilih Subkategori---</option>
                            <?php 
                            $host = mysqli_connect('localhost','root','','Fashion');
                            $query = mysqli_query($host, "select * from sub_kategori");
                            while ($data = mysqli_fetch_array($query)) {
                              # code...
                             ?>
                             <option value="<?php echo $data['id']?>"><?php echo $data['nama']; ?></option>
                      ...
                      <div class="form-group">
                        ...
                        <div class="col-sm-4">
                          ...
                          <input type="file" name="berkas" value="<?php echo $gambar;?>">
                        </div>
                      </div>
                      <div class="form-group">
                      ...
                      <div class="form-group">
                        ...
                        <div class="col-sm-6">
                          <input type="submit" name="save" class="btn bg-gradient-primary" value="Simpan" data-toggle="tooltip" title="Simpan Data Produk" style="color: white">
                          <a href="TabelProduk.php" class="btn bg-gradient-danger" data-toggle="tooltip" title="Batal" style="color: white">Batal</a>
                        </div>
                      </div>
                      <div class="col-sm-6">
                        <a href="TabelProduk.php" class="btn bg-gradient-dark" style="color: white;margin-top: 10px">Kembali</a>
                      </div>
                    </form>
                  </div> <!-- /.content -->
