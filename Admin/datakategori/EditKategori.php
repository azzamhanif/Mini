  ...
  <div id="wrapper">
    ...
    <ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
      ...
      <li class="nav-item active">
        <a class="nav-link" href="TabelKategori.php">
          <i class="fas fa-fw fa-table"></i>
    ...
    <div id="content-wrapper" class="d-flex flex-column">
      ...
      <div id="content">
        ...
        <div class="container-fluid">
          ...
          <p class="mb-4">Mengubah data kategori</p>
          ...
          <div class="card shadow mb-4">
            <div class="card-body">
              ...
              ?>
                <div class="container">
                  <div class="content">
                    <h2>Data Kategori &raquo; Edit Data</h2>
                    <hr />
                    
                    <?php
                    $id = $_GET['id']; // assigment id dengan nilai id yang akan diedit
                    $sql = mysqli_query($koneksi, "SELECT * FROM kategori WHERE id='$id'"); // query untuk memilih entri data dengan nilai id terpilih
                    if(mysqli_num_rows($sql) == 0){
                      header("Location: index.php");
                    }else{
                      $row = mysqli_fetch_assoc($sql);
                    }
                    if(isset($_POST['save'])){ // jika tombol 'Save' dengan properti name="save"
                      $id            = $_POST['id'];
                      $nama      = $_POST['nama'];

                      $update = mysqli_query($koneksi, "UPDATE kategori SET nama='$nama'WHERE id='$id'") or die(mysqli_error()); // query untuk mengupdate nilai entri dalam database
                      if($update){ // jika query update berhasil dieksekusi
                        // header("Location: edit.php?id=".$id."&pesan=sukses"); // tambahkan pesan=sukses pada url
                        echo '<div class="alert alert-success alert-dismissable"><button type="button" class="close" data-dismiss="alert" aria-hidden="true">&times;</button> Data berhasil diedit.</div>';
                    ...
                    <form class="form-horizontal" action="" method="post">
                      <div class="form-group">
                        ...
                        <div class="col-sm-2">
                          <input type="text" name="id" value="<?php echo $row ['id']; ?>" class="form-control" placeholder="Id Kategori" required>
                        </div>
                      </div>
                      <div class="form-group">
                      ...
                      <div class="form-group">
                        ...
                        <div class="col-sm-6">
                          <input type="submit" name="save" class="btn bg-gradient-primary" value="Simpan" data-toggle="tooltip" title="Simpan Data Kategori" style="color: white">
                          <a style="color: white" href="data.php" class="btn bg-gradient-danger" data-toggle="tooltip" title="Batal">Batal</a>
                        </div>
                      </div>
                      <div class="col-sm-6">
                        <a href="TabelKategori.php" class="btn bg-gradient-dark" style="color: white;margin-top: 10px">Kembali</a>
                      </div>
                    </form>
                  </div> <!-- /.content -->
