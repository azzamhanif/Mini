...
?>
	<div class="container">
		<div class="content">
			...
			<h2>Pencarian Data Sub Kategori &raquo; Id Sub Kategori: <?php echo $id; // menampilkan id ?></h2>
			<hr />
			
			<?php
			$sql = mysqli_query($koneksi, "SELECT * FROM subkategori WHERE id='$id'"); // query untuk memilih entri dengan id terpilih
			...
			?>
			<!-- bagian ini digunakan untuk menampilkan data sub kategori hasil pencarian-->
