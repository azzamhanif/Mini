    ...
    <div id="content-wrapper" class="d-flex flex-column">
      ...
      <div id="content">
        ...
        <div class="container-fluid">
          ...
          <p class="mb-4">Mengubah data pegawai</p>
                  ...
                  <div class="content">
                    ...
                    if(isset($_POST['save'])){ // jika tombol 'Save' dengan properti name="save" pada baris 135 ditekan
                      ...
                      if($update){ // jika query update berhasil dieksekusi
                        ...
                        // header("Location: EditPegawai.php?id=".$id."&pesan=sukses"); // tambahkan pesan=sukses pada url
                    ...
                    <form class="form-horizontal" action="" method="post">
                      ...
                      <div class="form-group">
                        ...
                        <div class="col-sm-6">
                          <input type="submit" name="save" class="btn bg-gradient-primary" value="Simpan" data-toggle="tooltip" title="Simpan Data Pegawai" style="color: white">
