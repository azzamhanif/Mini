	  ...
	  <div class="container">
		...
		<div class="collapse navbar-collapse" id="myNavbar">
		  <ul class="nav navbar-nav">
			...
			<li><a href="data.php" data-toggle="tooltip" data-placement="bottom" title="Lihat Data Produk"><span class="glyphicon glyphicon-list"></span> Lihat Data Produk</a></li>
			<li><a href="tambah.php" data-toggle="tooltip" data-placement="bottom" title="Tambah Data Produk" ><span class="glyphicon glyphicon-user"></span> Tambah Data Produk</a></li>
		  </ul>
