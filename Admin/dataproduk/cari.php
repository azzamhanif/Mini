...
?>
	<div class="container">
		<div class="content">
			...
			<h2>Pencarian Data Produk &raquo; Id Produk: <?php echo $id; // menampilkan id ?></h2>
			<hr />
			
			<?php
			$sql = mysqli_query($koneksi, "SELECT * FROM produk WHERE id='$id'"); // query untuk memilih entri dengan id terpilih
			...
			if(isset($_GET['aksi']) == 'delete'){ // jika tombol 'Hapus Data' pada baris 74 ditekan
				$delete = mysqli_query($koneksi, "DELETE FROM produk WHERE id='$id'"); // query delete entri dengan id terpilih
			...
			?>
			<!-- bagian ini digunakan untuk menampilkan data produk hasil pencarian-->
