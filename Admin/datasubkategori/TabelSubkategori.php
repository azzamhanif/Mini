  ...
  <div id="wrapper">
    ...
    <ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
      ...
      <li class="nav-item active">
        <a class="nav-link" href="TabelSubkategori.php">
          <i class="fas fa-fw fa-table"></i>
    ...
    <div id="content-wrapper" class="d-flex flex-column">
      ...
      <div id="content">
        ...
        <div class="container-fluid">
          ...
          <!-- Page Heading -->
          <h1 class="h3 mb-2 text-gray-800">Tabel Data Subkategori</h1>
          <p class="mb-4">Berisi detail subkategori yang disajikan dalam bentuk tabel.</p>
                ...
                <div class="container">
                  <div class="content">
                    ...
                    if(isset($_GET['aksi']) == 'delete'){ // mengkonfirmasi jika 'aksi' bernilai 'delete' merujuk pada baris 90 dibawah
                      ...
                      $cek = mysqli_query($koneksi, "SELECT * FROM sub_kategori WHERE id='$id'"); // query untuk memilih entri dengan id yang dipilih
                      if(mysqli_num_rows($cek) == 0){ // mengecek jika tidak ada entri id yang dipilih
                        ...
                        $result = mysqli_query($koneksi, "DELETE FROM sub_kategori WHERE id=$id"); // query untuk menghapus
                    ...
                    <div class="row"> 
                      ...
                      <div class="col-md-1" style="margin-bottom: 10px">
                        <a href="TambahSubkategori.php" class="btn bg-gradient-success" style="color: white;">Tambah SubKategori</a>
                      </div>
                    </div>
                    ...
                    <div class="table-responsive">
                      <table class="table table-striped table-hover">
                        ...
                        $sql = mysqli_query($koneksi, "SELECT * FROM sub_kategori ORDER BY id ASC");
                          ...
                          while($row = mysqli_fetch_assoc($sql)){ // fetch query yang sesuai ke dalam array
                            ...
                            echo '
                              <td>
                                ...
                                <a href="EditSubkategori.php?id='.$row['id'].'" title="Edit Data" data-toggle="tooltip" class="btn btn-primary btn-sm"><span class="glyphicon glyphicon-edit" aria-hidden="true"></span></a>
                                <a href="TabelSubkategori.php?aksi=delete&id='.$row['id'].'" title="Hapus Data" data-toggle="tooltip" onclick="return confirm(\'Anda yakin akan menghapus data '.$row['nama'].'?\')" class="btn btn-danger btn-sm"><span class="glyphicon glyphicon-trash" aria-hidden="true"></span></a>
                              </td>
                            </tr>
                            ';
