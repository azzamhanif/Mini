    ...
    <div id="content-wrapper" class="d-flex flex-column">
      ...
      <div id="content">
        ...
        <div class="container-fluid">
          ...
          <p class="mb-4">Menambah Kategori baru</p>
                  ...
                  <div class="content">
                    ...
                    <form class="form-horizontal" action="" method="post">
                      ...
                      <div class="form-group">
                        ...
                        <div class="col-sm-6">
                          <input type="submit" name="add" class="btn bg-gradient-primary" value="Simpan" data-toggle="tooltip" title="Simpan Data Kategori" style="color: white">
                          <a href="TabelKategori.php" class="btn bg-gradient-danger" style="color: white" data-toggle="tooltip" title="Batal">Batal</a>
                        </div>
                      </div>
                      <div class="col-sm-6">
