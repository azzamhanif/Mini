                ...
                <div class="container">
                  <div class="content">
                    ...
                    <div class="row"> 
                      ...
                      <div class="col-md-1">
                        <a href="TambahPegawai.php" class="btn bg-gradient-success" style="color: white;">Tambah Pegawai</a>
                      </div>
                    </div>
                    ...
                    <div class="table-responsive">
                      <table class="table table-striped table-hover">
                        ...
                        <?php
                        $sql = mysqli_query($koneksi, "SELECT * FROM pegawai ORDER BY id ASC");
                        $no = 1; // mewakili data dari nomor 1
                          while($row = mysqli_fetch_assoc($sql)){ // fetch query yang sesuai ke dalam array
                            ...
                            <tr>
                              ...
                              // }
                            echo '
                                <a href="EditPegawai.php?id='.$row['id'].'" title="Edit Data" data-toggle="tooltip" class="btn btn-primary btn-sm"><span class="glyphicon glyphicon-edit" aria-hidden="true"></span></a>
                                <a href="EditPassword.php?id='.$row['id'].'" title="Ganti Password" data-toggle="tooltip" class="btn btn-warning btn-sm"><span class="glyphicon glyphicon-refresh" aria-hidden="true"></span></a>
                                <a href="TabelPegawai.php?aksi=delete&id='.$row['id'].'" title="Hapus Data" data-toggle="tooltip" onclick="return confirm(\'Anda yakin akan menghapus data '.$row['nama_lengkap'].'?\')" class="btn btn-danger btn-sm"><span class="glyphicon glyphicon-trash" aria-hidden="true"></span></a>
                              </td>
                            </tr>
                            ';
