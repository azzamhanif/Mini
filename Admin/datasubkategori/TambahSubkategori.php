    ...
    <div id="content-wrapper" class="d-flex flex-column">
      ...
      <div id="content">
        ...
        <div class="container-fluid">
          ...
          <!-- Page Heading -->
          <h1 class="h3 mb-2 text-gray-800">Tambah Subkategori</h1>
          <p class="mb-4">Menambah Subkategori baru</p>
                ...
                <div class="container">
                  <div class="content">
                    ...
                    if(isset($_POST['add'])){ // jika tombol 'Simpan' dengan properti name="add" pada baris 137 ditekan
                      ...
                      $cek = mysqli_query($koneksi, "SELECT * FROM sub_kategori WHERE id='$id'"); // query untuk memilih entri dengan id terpilih
                      $insert = mysqli_query($koneksi, "INSERT INTO `sub_kategori` (`id`, `nama`) VALUES('$id', '$nama');") or die(mysqli_error()); // query untuk menambahkan data ke dalam database
                    ...
                    <form class="form-horizontal" action="" method="post">
                      ...
                      <div class="form-group">
                        ...
                        <div class="col-sm-6">
                          <input type="submit" name="add" class="btn bg-gradient-primary" value="Simpan" data-toggle="tooltip" title="Simpan Data Sub Kategori" style="color: white">
