    ...
    <div id="content-wrapper" class="d-flex flex-column">
      ...
      <div id="content">
        ...
        <div class="container-fluid">
          ...
          <!-- Page Heading -->
          <h1 class="h3 mb-2 text-gray-800">Edit Subkategori</h1>
          <p class="mb-4">Mengubah data subkategori</p>
              ...
              ?>
                <div class="container">
                  <div class="content">
                    ...
                    $sql = mysqli_query($koneksi, "SELECT * FROM sub_kategori WHERE id='$id'"); // query untuk memilih entri data dengan nilai id terpilih
                    ...
                    if(isset($_POST['save'])){ // jika tombol 'Save' dengan properti name="save" pada baris 135 ditekan
                      ...
                      $update = mysqli_query($koneksi, "UPDATE sub_kategori SET nama='$nama'WHERE id='$id'") or die(mysqli_error()); // query untuk mengupdate nilai entri dalam database
                    ...
                    <form class="form-horizontal" action="" method="post">
                      ...
                      <div class="form-group">
                        ...
                        <div class="col-sm-6">
                          <input type="submit" name="save" class="btn bg-gradient-primary" value="Simpan" data-toggle="tooltip" title="Simpan Data Sub Kategori" style="color: white">
                          <a href="TabelSubkategori.php" class="btn bg-gradient-danger" data-toggle="tooltip" title="Batal" style="color: white">Batal</a>
                        </div>
                      </div>
                    </form>
                    <div class="col-sm-6">
                      <a href="TabelSubkategori.php" class="btn bg-gradient-dark" style="color: white;margin-top: 10px">Kembali</a>
                    </div>
                  </div> <!-- /.content -->
