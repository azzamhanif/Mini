    ...
    <div id="content-wrapper" class="d-flex flex-column">
      ...
      <div id="content">
        ...
        <div class="container-fluid">
          ...
          <p class="mb-4">Menambah produk baru</p>
            ...
            <div class="card-body">
             ...
             <?php 
              ...
              ?>
                <div class="container">
                  <div class="content">
                    <h2>Data Produk &raquo; Tambah Data</h2>
                    <hr />
                    ...
                    // $namagambar = $_FILES['file_gambar']['name'];
                    ...
                    //     if($ukuran < 1044070){
                    //         move_uploaded_file($file_tmp, 'img/'.$namagambar);
                    //         $valid_gambar = TRUE;
                    //     }else{
                    ...
                    if(isset($_POST['add'])){ // jika tombol 'Simpan' dengan properti name="add" pada baris 137 ditekan
                      ...
                      $insert = mysqli_query($koneksi, "INSERT INTO `produk` (`id`, `nama`, `deskripsi`, `idkategori`, `idsub_kategori`, `file_gambar`, `idpegawai`, `harga`) VALUES('$id', '$nama', '$deskripsi', '$idkategori', '$idsub_kategori', '$file_gambar', '$idpegawai', '$harga');") or die(mysqli_error()); // query untuk menambahkan data ke dalam database
                    ...
                    <form class="form-horizontal" method="post" enctype="multipart/form-data">
                      ...
                      <div class="form-group">
                        ...
                        <div class="col-sm-4">
                          ...
                          <div class="col-sm-4">
                          <input type="file" name="berkas" value="<?php echo $file_gambar;?>">
                        </div>
                        </div>
                      </div>
                      <div class="form-group">
                      ...
                      <div class="form-group">
                        ...
                        <div class="col-sm-6">
                          <input type="submit" name="add" class="btn bg-gradient-primary" value="Simpan" data-toggle="tooltip" title="Simpan Data Produk" style="color: #fff">
                          <a href="TabelProduk.php" class="btn bg-gradient-danger" data-toggle="tooltip" title="Batal" style="color: #fff">Batal</a>
                        </div>
                      </div>
                      <div class="col-sm-6">
