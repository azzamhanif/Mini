    ...
    <div id="content-wrapper" class="d-flex flex-column">
      ...
      <div id="content">
        ...
        <div class="container-fluid">
          ...
          <!-- Page Heading -->
          <h1 class="h3 mb-2 text-gray-800">Tabel Data Kategori</h1>
          <p class="mb-4">Berisi detail kategori yang disajikan dalam bentuk tabel.</p>
                ...
                <div class="container">
                  <div class="content">
                    ...
                    if(isset($_GET['aksi']) == 'delete'){ // mengkonfirmasi jika 'aksi' bernilai 'delete' merujuk pada baris 90 dibawah
                      ...
                      $cek = mysqli_query($koneksi, "SELECT * FROM kategori WHERE id='$id'"); // query untuk memilih entri dengan id yang dipilih
                      if(mysqli_num_rows($cek) == 0){ // mengecek jika tidak ada entri id yang dipilih
                        ...
                        $result = mysqli_query($koneksi, "DELETE FROM kategori WHERE id=$id"); // query untuk menghapus
                    ...
                    <div class="row"> 
                      ...
                      <div class="col-md-1" style="margin-bottom: 10px">
                        <a href="TambahKategori.php" class="btn bg-gradient-success" style="color: white;">Tambah Kategori</a>
                      </div>
                          ...
                          while($row = mysqli_fetch_assoc($sql)){ // fetch query yang sesuai ke dalam array
                            ...
                            echo '
                              <td>
                                ...
                                <a href="EditKategori.php?id='.$row['id'].'" title="Edit Data" data-toggle="tooltip" class="btn btn-primary btn-sm"><span class="glyphicon glyphicon-edit" aria-hidden="true"></span></a>
                                <a href="TabelKategori.php?aksi=delete&id='.$row['id'].'" title="Hapus Data" data-toggle="tooltip" onclick="return confirm(\'Anda yakin akan menghapus data '.$row['nama'].'?\')" class="btn btn-danger btn-sm"><span class="glyphicon glyphicon-trash" aria-hidden="true"></span></a>
                              </td>
                            </tr>
                            ';
