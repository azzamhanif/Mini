...
?>
	<div class="container">
		<div class="content">
			<h2>Data Kategori &raquo; Detail Kategori</h2>
			<hr />
			
			<?php
			$id = $_GET['id']; // mengambil data id dari id yang terpilih
			
			$sql = mysqli_query($koneksi, "SELECT * FROM kategori WHERE id='$id'"); // query memilih entri id pada database
			...
			?>
			<!-- bagian ini digunakan untuk menampilkan data kategori -->
